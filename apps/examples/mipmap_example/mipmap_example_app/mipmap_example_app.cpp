...
static mipmap_example_app_o *mipmap_example_app_create() {
	auto app = new ( mipmap_example_app_o );
...
static void process_events( mipmap_example_app_o *self ) {
...
static bool mipmap_example_app_update( mipmap_example_app_o *self ) {
...
static void mipmap_example_app_destroy( mipmap_example_app_o *self ) {
	delete ( self );
}

// ----------------------------------------------------------------------

ISL_API_ATTR void register_mipmap_example_app_api( void *api ) {
	auto  mipmap_example_app_api_i = static_cast<mipmap_example_app_api *>( api );
	auto &mipmap_example_app_i     = mipmap_example_app_api_i->mipmap_example_app_i;

	mipmap_example_app_i.initialize = initialize;
	mipmap_example_app_i.terminate  = terminate;

	mipmap_example_app_i.create  = mipmap_example_app_create;
	mipmap_example_app_i.destroy = mipmap_example_app_destroy;
	mipmap_example_app_i.update  = mipmap_example_app_update;
}
