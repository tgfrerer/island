#include "mesh_generator_example_app.h"
...
static void reset_camera( mesh_generator_example_app_o *self ); // ffdecl.

// ----------------------------------------------------------------------

static mesh_generator_example_app_o *mesh_generator_example_app_create() {
	auto app = new ( mesh_generator_example_app_o );

	pal::Window::Settings settings;
	settings
	    .setWidth( 1920 / 2 )
	    .setHeight( 1080 / 2 )
	    .setTitle( "Island // MeshGeneratorExampleApp" );
...
static bool mesh_generator_example_app_update( mesh_generator_example_app_o *self ) {
...
static void mesh_generator_example_app_destroy( mesh_generator_example_app_o *self ) {
...
ISL_API_ATTR void register_mesh_generator_example_app_api( void *api ) {
	auto  mesh_generator_example_app_api_i = static_cast<mesh_generator_example_app_api *>( api );
	auto &mesh_generator_example_app_i     = mesh_generator_example_app_api_i->mesh_generator_example_app_i;

	mesh_generator_example_app_i.initialize = initialize;
	mesh_generator_example_app_i.terminate  = terminate;

	mesh_generator_example_app_i.create  = mesh_generator_example_app_create;
	mesh_generator_example_app_i.destroy = mesh_generator_example_app_destroy;
	mesh_generator_example_app_i.update  = mesh_generator_example_app_update;
}
