...
struct le_path_api {
	...
	struct le_path_interface_t {
		...
		void        (* move_to                   ) ( le_path_o* self, Vertex const& p, bool isRelative);
		void        (* line_to                   ) ( le_path_o* self, Vertex const& p, bool isRelative);
		void        (* quad_bezier_to            ) ( le_path_o* self, Vertex const& p, Vertex const & c1, bool isRelative);
		void        (* cubic_bezier_to           ) ( le_path_o* self, Vertex const& p, Vertex const & c1, Vertex const & c2, bool isRelative );
