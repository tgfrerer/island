...
// declare function pointer to register_fun function
...
bool ApiLoader::register_api(void *p_api) {
  ...
  fptr = reinterpret_cast<register_api_fun_p_t>(dlsym(mHandle, "register_api"));
  if (!fptr) {
