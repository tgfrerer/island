...
extern pal_backend_vk_instance_o *create_instance( pal_backend_vk_api * );         // defined in instance_vk.cpp
extern void                       destroy_instance( pal_backend_vk_instance_o * ); // defined in instance_vk.cpp
