...
// This file was downloaded from: https://github.com/turanszkij/WickedEngine/blob/master/WickedEngine/Utility/h264.h 
//
...
namespace h264 {
    ...
    static void read_nal_header( NALHeader* nal, Bitstream* b );
    static void read_pps( PPS* pps, Bitstream* b );
    static void read_sps( SPS* sps, Bitstream* b );
    ...
    static void read_scaling_list( Bitstream* b, int* scalingList, int sizeOfScalingList, int* useDefaultScalingMatrixFlag ) {
	    int lastScale = 8;
		int nextScale = 8;
		int delta_scale;
    ...
    static void read_hrd_parameters( SPS* sps, Bitstream* b ) {
    ...
    static void read_rbsp_trailing_bits( Bitstream* b ) {
    ...
    static void read_vui_parameters( SPS* sps, Bitstream* b ) {
    ...
    static int more_rbsp_data( Bitstream* b ) {
	    // no more data
		if (b->eof()) { return 0; }
    ...
    static void read_ref_pic_list_reordering( SliceHeader* sh, Bitstream* b ) {
    ...
    static void read_pred_weight_table( SliceHeader* sh, const SPS* sps, const PPS* pps, Bitstream* b ) {
	    int i, j;
