...
static bool should_use_queries() {
	static auto should_use_status_queries = LE_SETTING( const bool, LE_SETTING_IDENTIFIER_SHOULD_USE_VIDEO_STATUS_QUERIES, true );
	return *should_use_status_queries;
}
