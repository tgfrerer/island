...
class LeRendergraphVisualizer : NoCopy, NoMove {
  ...
  public:
	...
	void update( le_rendergraph_o* rendergraph_to_draw_into, le_image_resource_handle_t* target_image, le_rendergraph_o* rendergraph_to_visualize ) {
		le_rendergraph_visualizer::le_rendergraph_visualizer_i.update( self, rendergraph_to_draw_into, target_image, rendergraph_to_visualize );
	}
