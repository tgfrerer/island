...
struct le_renderer_api {
	...
	struct command_buffer_transfer_encoder_interface_t{
		void                         ( *copy_to_buffer         )( le_command_buffer_encoder_o* self, le_buffer_resource_handle const& dst_buffer, size_t dst_offset, le_buffer_resource_handle const& src_buffer, size_t src_offset, size_t numBytes );
