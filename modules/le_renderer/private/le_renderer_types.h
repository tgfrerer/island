...
enum LeImageCreateFlagBits : LeImageCreateFlags {
	...
	LE_IMAGE_CREATE_2_D_VIEW_COMPATIBLE_BIT_EXT               = 0x00020000,
	LE_IMAGE_CREATE_FRAGMENT_DENSITY_MAP_OFFSET_BIT_QCOM      = 0x00008000,
...
enum LeAccessFlagBits : LeAccessFlags_t {
	...
	LE_ACCESS_FRAGMENT_SHADING_RATE_ATTACHMENT_READ_BIT_KHR = 0x00800000,
	LE_ACCESS_COMMAND_PREPROCESS_READ_BIT_NV                = 0x00020000,
	LE_ACCESS_COMMAND_PREPROCESS_WRITE_BIT_NV               = 0x00040000,
	LE_ACCESS_SHADING_RATE_IMAGE_READ_BIT_NV                = LE_ACCESS_FRAGMENT_SHADING_RATE_ATTACHMENT_READ_BIT_KHR,
	...
	LE_ACCESS_NONE_KHR                                      = LE_ACCESS_NONE,
};
...
enum LePipelineStageFlagBits : LePipelineStageFlags_t {
	...
	LE_PIPELINE_STAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR = 0x00400000,
	LE_PIPELINE_STAGE_COMMAND_PREPROCESS_BIT_NV                = 0x00020000,
	LE_PIPELINE_STAGE_SHADING_RATE_IMAGE_BIT_NV                = LE_PIPELINE_STAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR,
	...
	LE_PIPELINE_STAGE_NONE_KHR                                 = LE_PIPELINE_STAGE_NONE,
};
...
enum LeImageUsageFlagBits : LeImageUsageFlags_t {
	...
	LE_IMAGE_USAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR = 0x00000100,
	LE_IMAGE_USAGE_INVOCATION_MASK_BIT_HUAWEI               = 0x00040000,
	LE_IMAGE_USAGE_SHADING_RATE_IMAGE_BIT_NV                = LE_IMAGE_USAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR,
};
...
enum LeBuildAccelerationStructureFlagBitsKHR : LeBuildAccelerationStructureFlags_t {
	...
	LE_BUILD_ACCELERATION_STRUCTURE_MOTION_BIT_NV             = 0x00000020,
