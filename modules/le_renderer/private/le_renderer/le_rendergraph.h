...
struct le_renderpass_o {
	...
	std::vector<uint32_t>           resources_usage_flags;                    // whether the resource requires transient image views for this pass for example: made up of OR'ed `resource_use_flags` , indexed by `resources`
