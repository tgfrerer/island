...
void register_le_backend_vk_api( void *api_ ) {
	...
	le_device_vk_i.device_get_default_compute_queue               = device_get_default_compute_queue;
	le_device_vk_i.device_get_default_compute_queue_family_index  = device_get_default_compute_queue_family_index;
	le_device_vk_i.device_get_default_graphics_queue              = device_get_default_graphics_queue;
	le_device_vk_i.device_get_default_graphics_queue_family_index = device_get_default_graphics_queue_family_index;
