...
struct le_allocator_o {
	...
	uint64_t capacity                = 0;
	uint64_t alignment               = 256; // minimum allocation chunk size (should proabbly be VkPhysicalDeviceLimits::minTexelBufferOffsetAlignment - see bufferView offset "valid use" in Spec: 11.2 )
