...
struct le_graphics_pipeline_builder_api {
	...
	struct le_graphics_pipeline_builder_interface_t {
		...
		le_graphics_pipeline_builder_o * ( * create          ) ( le_pipeline_cache_o *pipeline_cache ); // TODO: needs to be created for a backend.
...
class LeGraphicsPipelineBuilder : NoCopy, NoMove {
  ...
  public:
	LeGraphicsPipelineBuilder( le_pipeline_cache_o *pipelineCache )
